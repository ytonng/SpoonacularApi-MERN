  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 backdrop-blur-md bg-white/70 p-10 rounded-2xl shadow-2xl w-96 flex flex-col gap-6">
        <h1 className="text-3xl font-extrabold text-center mb-2 tracking-tight text-gray-800">Register</h1>
        ...
        <p className="mt-2 text-center text-gray-700 text-sm">
          Already have an account? <Link to="/login" className="text-blue-600 underline hover:text-blue-800 transition">Login</Link>
        </p>
      </div>
    </div>
  );
